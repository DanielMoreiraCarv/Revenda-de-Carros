...
import Treinamento.Revenda.Service.Cli_ClienteService;
...
public class Cli_ClienteController {
	...
	@GetMapping(value = "/cliente/buscar/{cpf}", produces = { MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_XML_VALUE})
	...
	@PatchMapping("/cliente/mudar/{info}/{dadoNovo}/{cpf}")
