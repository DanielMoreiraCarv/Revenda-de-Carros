...
import static Treinamento.Revenda.Service.Fun_FuncionarioService.getFuncionarioPorCpf;
...
import Treinamento.Revenda.Service.Fun_FuncionarioService;
...
public class Fun_FuncionarioController {
	...
	@GetMapping(value = "/funcionario/{cpf}", produces = { MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_XML_VALUE})
	...
	@PostMapping("/funcionario/adicionar/{nome}/{cpf}/{numTelefone}/{email}/{dia}/{mes}/{ano}/{codConta}/{agencia}")
	...
	@PutMapping("/funcionario/mudar/{cpf}")
	...
	@PatchMapping("/funcionario/{info}/{dadoNovo}/{cpf}")
