...
public class For_Fornecedor {
	...
	public void setFor_nom_nome(String for_nom_nome) {
		...
		try (Connection conexao = ConexaoBd.getConexao()) {
			...
			String sql = "UPDATE FOR_FORNECEDOR SET for_nom_nome = ? WHERE for_cod_cpf = ? ";
	...
	public void setFor_num_numeroTelefone(String for_num_numeroTelefone) {
		...
		try (Connection conexao = ConexaoBd.getConexao()) {
			PreparedStatement stmt = null;
			String sql = "UPDATE FOR_FORNECEDOR SET for_num_numerotelefone = ? WHERE for_cod_cpf= ?";
			stmt = conexao.prepareStatement(sql);
			stmt.setString(2, for_cod_cpf);
	...
	public void setFor_nom_email(String for_nom_email) {
		...
		try (Connection conexao = ConexaoBd.getConexao()) {
			PreparedStatement stmt = null;
			String sql = "UPDATE FOR_FORNECEDOR SET for_nom_email = ? WHERE for_cod_cpf= ?";
			stmt = conexao.prepareStatement(sql);
			stmt.setString(2, for_cod_cpf);
	...
	public void setFor_cod_contaBancaria(String for_cod_contaBancaria) {
		...
		try (Connection conexao = ConexaoBd.getConexao()) {
			PreparedStatement stmt = null;
			String sql = "UPDATE FOR_FORNECEDOR SET for_cod_contaBancaria = ? WHERE for_cod_cpf= ?";
			stmt = conexao.prepareStatement(sql);
			stmt.setString(2, for_cod_cpf);
	...
	public void setFor_nom_agenciaBancaria(String for_nom_agenciaBancaria) {
		...
		try (Connection conexao = ConexaoBd.getConexao()) {
			PreparedStatement stmt = null;
			String sql = "UPDATE FOR_FORNECEDOR SET for_nom_agenciaBancaria = ? WHERE for_cod_cpf= ?";
			stmt = conexao.prepareStatement(sql);
			stmt.setString(2, for_cod_cpf);
